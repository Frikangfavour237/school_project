<style>
    #layoutSidenav_nav{
        box-shadow: 0 15px 12px rgba(0, 8, 3, 0.1);
    }
</style> 
<div id="layoutSidenav_nav">
     <nav class="sb-sidenav accordion "style="background: #fff; " id="sidenavAccordion">
         <div class="sb-sidenav-menu">
             <div class="nav">
                 <div class="sb-sidenav-menu-heading text-black">Dashboard</div>
                 <span style="font-style: italic; margin-left:15px; font-size:12px;">Dashboard</span>
                 <a class="nav-link text-black" style="height:50px;" href="index.php">
                     <div class="sb-nav-link-icon">
                     <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="24" height="24" color="black" fill="black">
                     ...
                     <p style="padding-top:15px; margin-left:9px;"> Dashboard</p>
                 </a>
                 
                 <a class="nav-link text-black" style="height:50px;" href="studs.php">
                 <div class="sb-nav-link-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
            <path d="M12 2C10.3431 2 9 3.34315 9 5C9 6.65685 10.3431 8 12 8C13.6569 8 15 6.65685 15 5C15 3.34315 13.6569 2 12 2ZM12 10C9.79086 10 8 11.7909 8 14V16H16V14C16 11.7909 14.2091 10 12 10ZM4 16V14C4 10.6863 6.68629 8 10 8H14C17.3137 8 20 10.6863 20 14V16H22V18H2V16H4Z"/>
    ...
    </div> <p style="padding-top:15px; margin-left:17px;">Student attendance</p>
                 </a>
                
                 <span style="font-style: italic; margin-left:15px; font-size:12px;">Attendance analysis</span>
                 <a class="nav-link text-black" style="height:50px;" href="arecord.php">
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="24" height="24" color="white" fill="black"><path d="M192 0c-41.8 0-77.4 26.7-90.5 64L64 64C28.7 64 0 92.7 0 128L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64l-37.5 0C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM128 256a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM80 432c0-44.2 35.8-80 80-80l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16L96 448c-8.8 0-16-7.2-16-16z"/></svg>
                    <p style="padding-top:15px; margin-left:17px;">Attendance Analysis</p>
                 </a>

                 <span style="font-style: italic; margin-left:15px; font-size:12px;">Feed</span>
                 <a class="nav-link text-black" style="height:50px;" href="feedview.php">
                     ...
                     <p style="padding-top:15px; margin-left:17px;">Feedback Analysis</p>
\                 </a>

                 <a class="nav-link text-black" style="height:50px;" href="setting.php">
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24" color="white" fill="black"><path d="M495.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-43.3 39.4c1.1 8.3 1.7 16.8 1.7 25.4s-.6 17.1-1.7 25.4l43.3 39.4c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-55.7-17.7c-13.4 10.3-28.2 18.9-44 25.4l-12.5 57.1c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-12.5-57.1c-15.8-6.5-30.6-15.1-44-25.4L83.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l43.3-39.4C64.6 273.1 64 264.6 64 256s.6-17.1 1.7-25.4L22.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l55.7 17.7c13.4-10.3 28.2-18.9 44-25.4l12.5-57.1c2-9.1 9-16.3 18.2-17.8C227.3 1.2 241.5 0 256 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l12.5 57.1c15.8 6.5 30.6 15.1 44 25.4l55.7-17.7c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM256 336a80 80 0 1 0 0-160 80 80 0 1 0 0 160z"/></svg>
                    <p style="padding-top:15px; margin-left:17px;"> Settings </p>
                 </a>
             </div>
         </div>
