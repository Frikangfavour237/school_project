     ...
     <nav class="sb-sidenav accordion "style="background: #fff; " id="sidenavAccordion">
         <div class="sb-sidenav-menu">
             <div class="nav">
                 ...
                 <span style="font-style: italic; margin-left:15px; font-size:12px;">Manage</span>
                 ...
                 <span style="font-style: italic; margin-left:15px; font-size:12px;">analyse</span>
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="24" height="24" color="white" fill="black"><path d="M192 0c-41.8 0-77.4 26.7-90.5 64L64 64C28.7 64 0 92.7 0 128L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64l-37.5 0C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM128 256a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM80 432c0-44.2 35.8-80 80-80l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16L96 448c-8.8 0-16-7.2-16-16z"/></svg>
                    <p style="padding-top:15px; margin-left:17px;">Attendance Record</p>
                 </a>

                 <a class="nav-link text-black" style="height:50px;" href="doc.php">
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="24" height="24" color="white" fill="black"><path d="M0 64C0 28.7 28.7 0 64 0L224 0l0 128c0 17.7 14.3 32 32 32l128 0 0 288c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64zm384 64l-128 0L256 0 384 128z"/></svg>
                     <p style="padding-top:15px; margin-left:17px;">Document</p>
                 </a>
                 ...
                 <a class="nav-link text-black" style="height:50px;" href="feedview.php">
                     ...
                     <p style="padding-top:15px; margin-left:17px;">Feedback view</p>
                 </a>
