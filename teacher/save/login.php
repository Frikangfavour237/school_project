...
<html lang="en">
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-9 col-lg-5 col-xl-6 col-xxl-8">
          ...
          <div class="card-body p-3 p-md-4 p-xl-3">
            <div class="row">
              <div class="col-12">
                <div class="mb-5">
                  ...
                  <h2 class="h4 text-center">Login to your account</h2>
              ...
              <div class="row overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-check m-0">
                    ...
                    <label class="form-check-label m-0 text-secondary" for="iAgree">
                      I agree to the <a href="#!" class="link-primary m-0 text-decoration-none">terms and conditions</a>
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <p class="m-0 text-secondary text-center">Don't have an account? <a href="register.php" class="link-primary text-decoration-none">Login</a></p>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <p class="mt-2 mb-2" style="text-align: center;">Or continue with</p>
